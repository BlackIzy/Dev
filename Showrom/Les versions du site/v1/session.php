            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                      <?php // affichage du formulaire avec la variable super global POST pour la transmission des données vers la page session_action.php ?>
                        <form id = "main_slider" action ="session_action.php" method ="post">
                            <div class="row">
                            <div class=" col-md-12">
                                <h2>Déjà<strong class="white"> inscrit ?</strong></h2>
                            </div>
